...
export const fetchStore = async (collection: string, data: dashboardModel.Anchor) =>
  request(`/api/dashboard-store-fetch?collection=${collection}`, {method: 'POST', data});

export const fetchStores = async (collection: string, data: dashboardModel.Anchor[]) =>
...
export const fetchLayout = async (collection: string, data: dashboardModel.TemplatePanel) =>
